package com.chargingstatusmonitor.souhadev.ui.fragments.batteryinfo;
...
import com.chargingstatusmonitor.souhadev.BatteryInfoReceiver;
...
public class BatteryInfoFragment extends Fragment implements BatteryListener {
    ...
    public void onBatteryChanged(Intent intent) {
        ...
        if (isExtraPresent) {
            ...
            Toast.makeText(requireContext(), "No Battery present", Toast.LENGTH_SHORT).show();
        }
    }
