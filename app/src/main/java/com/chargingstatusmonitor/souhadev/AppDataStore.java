...
public class AppDataStore {
    ...
    public static Preferences.Key<Boolean> DISCHARGING_ALARM = PreferencesKeys.booleanKey("discharging_alarm");
    ...
    public Flowable<Integer> getIntegerValue(Preferences.Key<Integer> key) {
        return dataStore.data()
                .map(preferences -> preferences.get(key) == null ? 0 : preferences.get(key));
    }
