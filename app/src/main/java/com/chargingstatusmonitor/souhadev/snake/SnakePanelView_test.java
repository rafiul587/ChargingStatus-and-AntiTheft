...
public class SnakePanelView_test extends View {
  private final static String TAG = SnakePanelView_test.class.getSimpleName();
  ...
  public SnakePanelView_test(Context context) {
    this(context, null);
  }

  public SnakePanelView_test(Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public SnakePanelView_test(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
