...
*/
            ...
            //canvas.drawRect(outerRadii, padding / 10f, (width - outerRadii), height - (padding / 10f), paint);
...
//      Drawing Switch Thumb here
    ...
    @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        leftFgArc.set(padding / 10f,padding / 10f, (outerRadii << 1)- (padding / 10f), height - (padding / 10f));
        rightFgArc.set(width - (outerRadii << 1) + (padding / 10f),padding / 10f, width - (padding / 10f), height - (padding / 10f));
    }
